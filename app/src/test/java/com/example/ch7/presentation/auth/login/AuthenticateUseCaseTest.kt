...
class AuthenticateUseCaseTest {
    ...
    @Test
    fun `test invoke return token`() = runTest{
        //Given
        val username = "febi"
        val password = "123456"
        val expected = "token"
    ...
    fun `test invoke throws invalid username or password`() = runTest {
        //Given
        val username = ""
        val password = ""
    ...
    @Test(expected = UnsupportedOperationException::class)
    fun `test invoke throws wrong username or password`() = runTest {
        //Given
